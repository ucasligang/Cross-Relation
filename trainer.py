...
if __name__ == '__main__':
    torch.backends.cudnn.benchmark = True    # optimize convolution options
    ImageFile.LOAD_TRUNCATED_IMAGES = True
    parser = argparse.ArgumentParser(description='ATL_Net in PyTorch')
    parser.add_argument('-c', '--config', default="./config/CUB_Conv64F_5way_1shot.json", type=str, help='config file path (default: None)')
